    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="absolute top-36 md:top-24 right-4 md:right-[5.5rem] z-50 w-72 cristal-fume rounded-[28px] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)]"
        >
          <div className="p-3 bg-white/5 border-b border-white/5 flex items-center justify-between">
            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] flex items-center gap-2">
              <Calculator size={14} className="text-slate-500" /> Calculadora
            </span>
